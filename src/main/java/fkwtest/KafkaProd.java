...
public class KafkaProd {
    ...
    public static void main(String[] args) throws Exception{
        ...
        props.put("value.serializer", "fkwtest.SerialData");
        ...
        producer.send(new ProducerRecord<>(topicName,"Reading1: ",m1)).get();
        producer.send(new ProducerRecord<>(topicName,"Reading2: ",m2)).get();
